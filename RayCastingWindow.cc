...
void RayCastingWindow::render()
{
	...
	SDL_SetRenderDrawColor(_renderer.get(), 174, 238, 237, 255);
	SDL_RenderFillRect(_renderer.get(), &r_sky);
	SDL_SetRenderDrawColor(_renderer.get(), 34, 140, 33, 255);
	...
	SDL_SetRenderDrawColor(_renderer.get(), 255, 255, 255, 155);
